...
@section('content')
    <main class="p-6 flex flex-col items-center justify-center min-h-screen bg-black bg-opacity-60">
        <div class="max-w-3xl mx-auto p-6 bg-gray-900 rounded-xl shadow-lg border border-green-400 text-white">
            <h2 class="text-2xl font-bold text-green-300 mb-6">✏️ Editar Película</h2>
            ...
            <form action="{{ route('admin.movies.update', $movie->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" required
                        class="w-full px-4 py-2 bg-gray-800 border border-green-400 rounded-lg text-white">{{ old('description', $movie->description) }}</textarea>
                </div>
