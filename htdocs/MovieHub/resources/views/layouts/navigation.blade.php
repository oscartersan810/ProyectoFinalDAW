<nav class="px-6 py-4 bg-gradient-to-b from-gray-900 to-gray-800 shadow-lg sticky top-0 z-50 border-b border-gray-700">
    <div class="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <!-- Desktop Navigation -->
        <ul id="nav-links" class="hidden md:flex space-x-2 items-center">
            <li>
            ...
            <li>
                <a href="{{ route('tops') }}" class="text-gray-300 hover:text-yellow-400 transition duration-300 flex items-center py-2 px-3 rounded-lg hover:bg-gray-700">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li class="relative group">
                ...
                <ul class="absolute left-0 mt-1 w-48 bg-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 border border-gray-700 transform translate-y-1">
                    <li>
                        <a href="{{ route('reviews.movies') }}" class="block px-4 py-3 hover:bg-gray-700 text-gray-300 hover:text-yellow-400 transition flex items-center">
                    ...
                    <li>
                        <a href="{{ route('reviews.series') }}" class="block px-4 py-3 hover:bg-gray-700 text-gray-300 hover:text-yellow-400 transition flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li class="relative group ml-4">
                ...
                <ul class="absolute right-0 mt-2 w-56 bg-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 border border-gray-700 transform translate-y-1">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}" class="block px-4 py-3 hover:bg-gray-700 text-gray-300 hover:text-yellow-400 transition flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
