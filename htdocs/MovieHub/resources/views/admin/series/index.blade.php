                        ...
                        <tr class="hover:bg-gray-750 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex-shrink-0 h-20 w-16">
                                    @if($serie->poster)
                                        <img class="h-20 w-16 rounded-lg object-cover border border-gray-600 shadow" src="{{ asset('storage/' . $serie->poster) }}" alt="Póster">
                                    @else
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-300 max-w-xs truncate" title="{{ $serie->description }}">
