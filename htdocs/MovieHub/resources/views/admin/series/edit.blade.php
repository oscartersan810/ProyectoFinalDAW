...
@section('content')
    <main class="p-6 flex flex-col items-center justify-center min-h-screen bg-black bg-opacity-60">
        <div class="max-w-3xl mx-auto p-6 bg-gray-900 rounded-xl shadow-lg border border-yellow-400 text-white">
            <h2 class="text-2xl font-bold text-yellow-300 mb-6">✏️ Editar Serie</h2>
            ...
            <form action="{{ route('admin.series.update', $serie->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" required
                        class="w-full px-4 py-2 bg-gray-800 border border-yellow-400 rounded-lg text-white">{{ old('description', $serie->description) }}</textarea>
                </div>
